...
//string promt = "Write a poem about the sea in the style of Shakespeare.";
//ChatResponse chatResponse = await chatClient.GetResponseAsync(promt);
//Console.WriteLine(chatResponse);
#endregion

#region Streaming Completion
//string promt = "Write a poem about the sea in the style of Shakespeare.";
//var response = chatClient.GetStreamingResponseAsync(promt);
...
//    Please clasify the following sentences into the categories:
//    - 'Complaint'
//    - 'Suggestion'
//    - 'Praise'
//    - 'Other'
...
//    2) "You shoud add a night mode."
//    3) "When I try the log in, it keeps failing."
//    4) "The app is decent"
//    """;
//Console.WriteLine($"user >>> {classificationPrompt}");
//var classificationResponse = await chatClient.GetResponseAsync(classificationPrompt);
